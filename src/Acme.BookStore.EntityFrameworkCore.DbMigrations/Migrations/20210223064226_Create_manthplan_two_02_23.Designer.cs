...
namespace Acme.BookStore.Migrations
{
    ...
    [Migration("20210223064226_Create_manthplan_two_02_23")]
    partial class Create_manthplan_two_02_23
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.BookStore.MonthPlans.MonthlPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AchievementOfSuperiorReviewGoals")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ActualCompletion")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ActualCompletionTime")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ProposedGoal")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SuperiorScore")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TaskCompletionRate")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TaskScore")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("WorkPlanContent")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("AppMonthlPlanTables");
                });

            modelBuilder.Entity("Acme.BookStore.User.StaffUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.BookStore.MonthPlans.MonthlPlan", b =>
                {
                    b.HasOne("Acme.BookStore.User.StaffUser", null)
                        .WithMany()
